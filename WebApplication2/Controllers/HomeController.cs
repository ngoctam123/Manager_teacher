...
namespace WebApplication2.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            List<Menu> listMenu = db.Menus.OrderByDescending(x => x.CreatedDate).ToList();
        ...
        public ActionResult ManageTeacher()
        {
            ...
            var listScience = db.Sciences.Where(x => x.ID > 0).OrderByDescending(y => y.CreatedDate).ToList();
        ...
        {
            using (ManagementTeacherWorkEntities1 dc = new ManagementTeacherWorkEntities1())
            {
